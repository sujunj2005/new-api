...
export const STATIC_I18N_KEYS = [
  ...
  // Attribution ops gap closure (Phase 6 plan 6.1, G-1..G-5 labels)
  'Customer List',
  'Assign Attribution',
  'Attribution Audit',
  'Attribution Changes',
  ...
  // Super admin adjustment UI (Phase 6 plan 6.2, A7/A8 labels)
  'Manual Flow',
  ...
  'Distributor ID must be a positive integer',
  'Manual flow created',
  'Adjust Statement',
  'Adjust',
  'Current Settle Amount',
  'Delta (cents)',
  'Enter delta in cents',
